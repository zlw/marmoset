...
object MarmosetTokenTypes {
    ...
    val INTERPOLATION_START = IElementType("MARMOSSET_INTERPOLATION_START", MarmosetLanguage)
    val INTERPOLATION_END = IElementType("MARMOSSET_INTERPOLATION_END", MarmosetLanguage)

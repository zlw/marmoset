...
- Implementation status: In progress (`std.basics`, `std.bytes`, `std.file`, and trait-shaped `std.io` proof slices landed; broader stdlib expansion pending)

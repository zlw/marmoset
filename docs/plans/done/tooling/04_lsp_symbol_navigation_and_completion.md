...
- 2026-04-28 16:25 CEST: Moved the completed milestone from `docs/plans/todo/tooling/02_lsp_symbol_navigation_and_completion.md` to `docs/plans/done/tooling/04_lsp_symbol_navigation_and_completion.md` and updated `docs/ROADMAP.md`.

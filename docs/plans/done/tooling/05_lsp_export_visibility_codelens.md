...
- 2026-04-28 16:25 CEST: Moved the implemented milestone from `docs/plans/todo/tooling/03_lsp_export_visibility_codelens.md` to `docs/plans/done/tooling/05_lsp_export_visibility_codelens.md` and updated `docs/ROADMAP.md`.

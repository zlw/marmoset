...
type Box struct {
	Data0 *Record_payload_Option_int64_tag_int64
	Tag int8
}
...
func Box_Wrap(v0 Record_payload_Option_int64_tag_int64) Box {
...
type Record_payload_Option_int64_tag_int64 struct{payload Option_int64; tag int64}
...
func main() {
    value := Box_Wrap(Record_payload_Option_int64_tag_int64{payload: Option_int64_Some(int64(5)), tag: int64(1)})
    _ = value
    var out int64
    __scrutinee_0 := value
    switch __scrutinee_0.Tag {
	case Box_Wrap_tag:
		if (((*((__scrutinee_0).Data0))).tag == int64(0)) && ((((*((__scrutinee_0).Data0))).payload).Tag == Option_int64_Some_tag) {
			v := (((*((__scrutinee_0).Data0))).payload).Data0
			_ = v
                out = v
		} else if (((*((__scrutinee_0).Data0))).tag == int64(1)) && ((((*((__scrutinee_0).Data0))).payload).Tag == Option_int64_Some_tag) {
			v := (((*((__scrutinee_0).Data0))).payload).Data0
			_ = v
                out = v
		} else {
